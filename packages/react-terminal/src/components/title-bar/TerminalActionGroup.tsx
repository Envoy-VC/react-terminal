...
import { Awaitable, TerminalActionGroupProps } from '~/types';

type Props = TerminalActionGroupProps & React.ComponentProps<'div'>;

const TerminalActionGroup = React.forwardRef<HTMLDivElement, Props>(
  (props, ref) => {
    const {
      maximizeHandler,
      closeHandler,
...
export default TerminalActionGroup;
